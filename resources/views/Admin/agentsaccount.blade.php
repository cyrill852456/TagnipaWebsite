...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{route('admin.agent')}}">Agent's Account</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Agent's Accounts</h1>
                    <p class="mb-4">Ikaw na bahala diri kya rey</p>
                    <a href="#"  data-toggle="modal" data-target="#addAgent" class="btn btn-primary btn-icon-split  mb-5">
                        <span class="icon text-white-50">
                            <i class="fas fa-user-plus"></i>
                          
                        </span>
                        <span class="text">Add Agent Account</span>
                    </a>
                    <a href="#" data-toggle="modal" data-target="#addInformation" class="btn btn-primary btn-icon-split  mb-5">
                        <span class="icon text-white-50">
                            <i class="fas fa-id-badge"></i>
                        </span>
                        <span class="text">Add Agent Account Information</span>
                    </a>
                    <!-- DataTales Example -->
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item"><a  class="nav-link active" id="segre-agent" data-toggle="tab" role="tab"   href="#agent-account">Agent Accounts</a></li>
                        <li class="nav-item"><a  class="nav-link"  role="tab" id="segre-record" data-toggle="tab" href="#agent-ownerinformation">Agent Information</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" role="tabpanel" aria-labelledby="junkshop-account" id="agent-account">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                @foreach ($agent as $account)
                                                <tr>
                                                    <input type="hidden" class="delete_val" value="{{$account->id}}">
                                                    <td>{{$account->name}}</td>
                                                    <td>{{$account->email}}</td>
                                                    <td><img src="/LGUProfiles/Agent_Image_profiles/{{$account->profile_pic}}" alt="Admin" class="rounded-circle" width="50"></td>
                                                    <td>{{$account->role}}</td>
                        ...
                        <div class="tab-pane fade show" role="tabpanel" aria-labelledby="junkshop-account" id="agent-ownerinformation">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">DataTables Example</h6>
                                </div>
    ...
    <!-- End of Page Wrapper -->
     ...
     <!-- Add  Agent  Modal -->
     <div class="modal fade" id="addAgent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalCenterTitle">Add Agent Account</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form  action="{{route('add-agent')}}" method="POST" id="ints" enctype="multipart/form-data">
                    @csrf
                                      ...
                                      <div class="form-group">
                                         <label class="float-left">Agent AccountName:</label>
                                      ...
                                      <div class="form-group">
                                         <label class="float-left">Agent Email:</label>
    ...
    <a class="scroll-to-top rounded" href="#page-top">
        <i class="fas fa-angle-up"></i>
           ...
           <!-- Edit  Junkshop Modal -->
           <div class="modal fade" id="editAgent" tabindex="-1" role="dialog" aria-labelledby="editJunkshop" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form  action="{{url('update-agent')}}" method="POST" id="ints" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                        ...
                                        <input type="hidden" name="agent_id" id="agent_id" />
                                          ...
                                          <div class="form-group">
                                             <label class="float-left">Agent Name:</label>
                                             <input type="text" name="name" id="name_agent"  class="form-control"  >
                                             <span class="text-danger">@error('name') {{$message}} @enderror</span>
                                          </div> 
                                          ...
                                          <div class="form-group">
                                             <label class="float-left">Agent Email:</label>
                                             <input type="email" name="email"  id="email_agent"  class="form-control">
                                             <span class="text-danger">@error('email') {{$message}} @enderror</span>
                                          </div>
     ...
     <!-- Add    Agent information Modal -->
     <div class="modal fade" id="addInformation" tabindex="-1" role="dialog" aria-labelledby="Information" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="JInformation">Add Agent Information</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                <form  action="{{route('add-agentinformation')}}" method="POST" id="ints" enctype="multipart/form-data">
                    @csrf
                     
                    
                    <div class="form-group">
                        <label for="junkshopers">Select Agent Account Name</label>
                            <select name="agent_id" class="form-control" id="junkshopers">
   ...
   function showers(){
    ...
    $('#formFile').change(function(){
            ...
            $.ajax({    
            type:"GET",
            url:"/edit-agent/"+agent_id,
            success: function(response){
            //console.log(response);
            $("#name_agent").val(response.agent.name);
            $('#email_agent').val(response.agent.email);
...
$(document).ready(function(){
    ...
    $('.deletebtn').click(function(e){
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type:"DELETE",
                url:'/agent-account-delete/'+delete_account,
                data: data,
                success: function (response) {
                    swal.fire(
